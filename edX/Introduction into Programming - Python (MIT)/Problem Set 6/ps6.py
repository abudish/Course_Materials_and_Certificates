...
def filterStories(stories, triggerlist):
    ...
    """
    # TODO: Problem 10
    # 1. Make an empty list of filteredStories:
    filteredStories = []
    # 2. For each story in stories:
    for story in stories:
        # 3. For each trigger in triggerlist:
        for trigger in triggerlist:
         # 4. If trigger fires on story:   
         if trigger.evaluate(story):
             # 5. Checking if story in filteredStories (to avoid duplicates):
             if story not in filteredStories:
                 # 6. Appending fired story in filteredStories:
                 filteredStories.append(story)
    # 7. Returning list with filtered stories:
...
def makeTrigger(triggerMap, triggerType, params, name):
    ...
    newTrigger = None
    # Defining a type of trigger and making the trigger of defined type:
    ...
    # Adding a new key-value pair for this trigger:
    triggerMap[name] = newTrigger

    # Returns a new instance of a trigger:
    return newTrigger
