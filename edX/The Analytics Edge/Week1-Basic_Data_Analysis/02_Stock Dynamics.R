# A stock market is where buyers and sellers trade shares of a company, and 
# is one of the most popular ways for individuals and companies to invest money. 
...
# Download and read the following files into R, using the read.csv function: IBMStock.csv, GEStock.csv,
# ProcterGambleStock.csv, CocaColaStock.csv, and BoeingStock.csv.
# (Do not open these files in any spreadsheet software before completing this problem because it might change the format of the Date field.)
...
# Right now, the date variable is stored as a factor. 
...
# Q: Our five datasets all have the same number of observations. How many observations are there in each data set?
str(Boeing) # Answer: 480 observations

# Problem 1.2 - Summary Statistics
# 
# What is the earliest year in our datasets?
min(ProcterGamble$Date) # Answer: 1970

# Problem 1.3 - Summary Statistics
# 
# What is the latest year in our datasets?
max(CocaCola$Date) # Answer: 2009

# Problem 1.4 - Summary Statistics
#
# What is the mean stock price of IBM over this time period?
mean(IBM$StockPrice) # Answer: 144.375

# Problem 1.5 - Summary Statistics
#
# What is the minimum stock price of General Electric (GE) over this time period?
min(GE$StockPrice) # Answer: 9.293636

# Problem 1.6 - Summary Statistics
#
# What is the maximum stock price of Coca-Cola over this time period?
max(CocaCola$StockPrice) # Answer:  146.5843

# Problem 1.7 - Summary Statistics
# 
# What is the median stock price of Boeing over this time period?
summary(Boeing) # Answer: 44.88

# Problem 1.8 - Summary Statistics
# 
# What is the standard deviation of the stock price of Procter & Gamble over this time period?
sd(ProcterGamble$StockPrice) # Answer: 18.19414
...
# and re-generate the plot (the character is quotes is the letter l, for line). 
...
# Around what year did Coca-Cola has its highest stock price in this time period?
        # Answer: 1973
        # double checking:
        CocaCola %>% filter(StockPrice == max(StockPrice)) %>% select(Date)
        
# Around what year did Coca-Cola has its lowest stock price in this time period?
        # Answer: 1980
        # double checking:
        CocaCola %>% filter(StockPrice == min(StockPrice)) %>% select(Date)
...
# adding the argument col="blue". You should now see in your plot the Coca-Cola stock price in red,
...
# or [301:432]. You don't need the "type" or "ylim" arguments for the lines function, but remember to make each company
# a different color so that you can tell them apart. Some color options are "red", "blue", "green", "purple", "orange", and "black". 
...
abline(v=as.Date("2000-03-30"), lwd=1)
        #Answer: GE
...
abline(v=as.Date("1997-11-01"), lwd=1, col="blue")
        # Answer: Boeing and P&G
...
abline(v=as.Date("2004-01-01"), lwd=1, col="purple")
abline(v=as.Date("2006-01-01"), lwd=1, col="purple")
        # Answer: Boeing
...
avgs_stc_price <- tapply(IBM$StockPrice, months(IBM$Date), mean) %>% sort()
avgs_stc_price > mean(IBM$StockPrice)
...
# Which month is this?
avgs_stc_GE <- tapply(GE$StockPrice, months(GE$Date), mean) %>% sort()
avgs_stc_CocaCola <- tapply(CocaCola$StockPrice, months(CocaCola$Date), mean) %>% sort()
        #Answer: April
...
#  After seeing these trends, we are ready to buy stock in certain months and sell it in others!
# But, we should be careful, because one really good or really bad year could skew the average
# to show a trend that is not really there in general.